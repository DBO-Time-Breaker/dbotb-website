...
# Rails.application.config.sorcery.submodules = %i[remember_me reset_password activity_logging]
Rails.application.config.sorcery.submodules = %i[remember_me]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `60 * 60 * 24 * 7`
    #
    user.remember_me_for = 60 * 60 * 24 * 7 * 365
    ...
    # Default: `5 * 60`
    #
    # user.reset_password_time_between_emails = Rails.env.development? ? 5 : 5*60
